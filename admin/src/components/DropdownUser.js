...
import { logout } from '../features/actions/auth/authenticationActions';
import { confirmAlert } from 'react-confirm-alert';
import toast from 'react-hot-toast';
import { clearReduxStoreData } from '../features/slices/auth/authenticationSlice';
...
const DropdownUser = () => {
  ...
  // This method is used to logout the user and clear session data.
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">
            {loggedInUserData?.data?.firstName}{' '}
            {loggedInUserData?.data?.lastName}
          </span>
          <span className="block text-xs">
            {loggedInUserData?.data?.userName}
          </span>
        </span>
