...
import { updateRoleDetails } from '../../../features/actions/auth/roleActions';
...
const UpdateRole = () => {
  ...
  const updateRoleHandler = (data) => {
    try {
      ...
      dispatch(updateRoleDetails(reqPayload));
    } catch (error) {
      console.log(error?.message);
    }
  };

  // Redirection to Roles Listing Page after role updated.
  useEffect(() => {
          ...
          >
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div>
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value, ref } }) => (
                    <Select
                      ...
                      value={value || null}
                      defaultValues={state?.permissions?.map((item) => {
                        return {
                          label: item?.permissionName,
                          value: item?._id,
                        };
                ...
                />
                <span className="fw-normal fs-6 dark:text-white text-danger">
