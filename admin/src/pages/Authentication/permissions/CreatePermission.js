...
import { addNewPermission } from '../../../features/actions/auth/permissionActions';
...
const CreatePermission = () => {
  ...
  const addPermissionHandler = (data) => {
    try {
      ...
      dispatch(addNewPermission(reqPayload));
    } catch (error) {
  ...
  return (
    <div className="p-4 lg:w-[70%] w-screen mx-auto">
      <div className="flex flex-col gap-9 ">
        <form onSubmit={handleSubmit(addPermissionHandler)}>
          <div
